...
export default {
  ...
  data () {
    return {
      ...
      categoryId: null,
      zoneId: null,
      inputDateFrom: DateUtil.getDatetime(DateUtil.getDefaultDate(), null, 'yyyy-MM-dd'),
      inputDateTo: DateUtil.getDatetime(DateUtil.getDefaultDate(), null, 'yyyy-MM-dd'),
      dateFrom: DateUtil.getDatetime(DateUtil.getDefaultDate(), null, 'yyyyMMdd'),
      dateTo: DateUtil.getDatetime(DateUtil.getDefaultDate(), null, 'yyyyMMdd'),
      historyType: 0,
