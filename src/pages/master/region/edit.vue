...
export default {
  ...
  data() {
    return {
      ...
      breadCrumbs: ViewHelper.createBreadCrumbItems('master', {text: 'region', href: '/master/region'}, ViewHelper.getDetailCaptionKey(this.$store.state.app_service.region.regionId)),
