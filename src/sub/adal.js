...
*/
  ...
  */
  ...
  AuthenticationContext.prototype._isParentOfSameOrigin = function() {
      try {
  ...
  AuthenticationContext.prototype.handleWindowCallback = function (hash) {
      ...
      if (this.isCallback(hash)) {
          ...
          else if (window.parent && this._isParentOfSameOrigin() && window.parent._adalInstance) {
              self = window.parent._adalInstance;
          }
          else if (window._adalInstance) {
              self = window._adalInstance;
          }
          ...
          if ((window.parent === window || !this._isParentOfSameOrigin()) && !isPopup) {
